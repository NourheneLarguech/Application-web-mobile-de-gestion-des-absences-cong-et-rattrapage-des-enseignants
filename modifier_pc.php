...
<?php
                        ...
                        $sql = "select * from personnel  where cin_per ='$c' ";
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="login100-more" id='m' style="background-image: url('modifier/images/personnel.jpg');"></div>

			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50" id='f'>
				<form class="login100-form validate-form" method="post" action="modifier_pc_php.php?id=<?php echo $c; ?>" id="formx">
					<span class="login100-form-title p-b-59">
					Modifier personnel du congé
					</span>
					...
					<div class="wrap-input100 validate-input" data-validate = "s'il vous plaît Entrer Numéro De Téléphone">
						...
						<input class="input100" type="number" id="tel" name="Telephone" placeholder="Numéro De Téléphone"  value="<?php echo $tel ;?>">
						<span class="focus-input100"></span>
					</div>
				...
				<div class="container-login100-form-btn">
						...
						<a href="consulter_pc.php" class="dis-block txt3 hov1 p-r-30 p-t-10 p-b-10 p-l-30">
							Annuler
