...
<html lang="en">
<head>
	<title>Modifier personnel d'absence</title>
	<meta charset="UTF-8">
...
<?php
                        ...
                        $sql = "select * from personnela  where cin_per ='$c' ";
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="login100-more" id='m' style="background-image: url('modifier/images/pa.jpg');"></div>

			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50" id='f'>
				<form class="login100-form validate-form" method="post" action="modifier_pa_php.php?id=<?php echo $c; ?>" id="formx">
					<span class="login100-form-title p-b-59">
					Modifier personnel d'absence
					</span>
					...
					<div class="wrap-input100 validate-input" data-validate="s'il vous plaît Entrer Mot De Passe ">
					...
					<div class="wrap-input100 validate-input" data-validate = "s'il vous plaît Entrer Numéro De Téléphone">
						<span class="label-input100">Télèphone:</span>
						<input class="input100" type="text" name="Telephone" id="tel" placeholder="Numéro De Téléphone"  value="<?php echo $tel ;?>">
						<span class="focus-input100"></span>
					</div>
				...
				<div class="container-login100-form-btn">
						...
						<a href="consulter_pa.php" class="dis-block txt3 hov1 p-r-30 p-t-10 p-b-10 p-l-30">
							Annuler
...
$titre = "Erreur ",
$text = "Numéro de téléphone est composé par 8 entier";
