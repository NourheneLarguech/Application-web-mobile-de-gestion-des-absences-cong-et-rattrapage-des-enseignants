...
<html>
<head>
<title>Consulter la liste des demandes des congés acceptées </title>
				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h1><b>la liste des demandes des congés acceptées </b></h1>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="">la liste des demandes des congés traitées</a></li>
...
?> 
             ...
             while($row=mysqli_fetch_array($res)){
                if($row['etat']=="Accepter"){
                 ...
                 echo"<td  class='table-plus'>".$row['etat']."</td></tr>";
