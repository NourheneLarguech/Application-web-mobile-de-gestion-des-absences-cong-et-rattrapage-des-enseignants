...
<html>
<head>
<title>Consulter le nombre d'absences</title>
				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h1><b>Consulter le nombre d'absences</b></h1>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="">Nombre d'absence</a></li>
...
$req="select * from enseignant where $x=cin_ens " ;
