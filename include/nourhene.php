        ...
        <div class="col-xs-12">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input name="username" maxlength="200" type="text" required="required" class="form-control" placeholder="username"  />
                </div>
                <button class="btn btn-primary nextBtn btn-lg pull-right" type="button" >Next</button>
            </div>
        </div>
        ...
        <div class="col-xs-12">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input name="password" maxlength="200" type="password" required="required" class="form-control" placeholder="Enter Company Name" />
                </div>
                <div class="form-group">
                    <label class="control-label">Repeat Password</label>
                    <input name="rpassword" maxlength="200" type="text" required="required" class="form-control" placeholder="username"  />
                </div>
