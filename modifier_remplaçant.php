...
<html lang="en">
<head>
	<title>Modifier Enseignant Remplaçant</title>
	<meta charset="UTF-8">
	...
	<div class="limiter">
		<div class="container-login100">
			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50" id='f'>
				<form class="login100-form validate-form" method="post"  id="formx" action="modifier_enseignant_remplaçant2.php?id=<?php echo $c ?>">
					<span class="login100-form-title p-b-59">
					Modifier Enseignant Remplçant
					</span>
				...
				<div class="container-login100-form-btn">
						...
						<a href="consulter_remplaçant.php" class="dis-block txt3 hov1 p-r-30 p-t-10 p-b-10 p-l-30">
							Annuler
