...
<html>
<head>
<title>Profil personnel du congé</title>
				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<div class="title">
								<h4>Profile personnel du congé</h4>
							</div>
							
							<?php
						
							$x=$_SESSION['id'];
							 $req="select * from personnel where cin_per= $x";
...
$row=mysqli_fetch_array($res);?>
    ...
    <i class="icon-copy fa fa-arrow-circle-right" aria-hidden="true"></i> &nbsp;
			...
			<div class="wrap-login100" style='margin-left:400px'>
				<form class="login100-form validate-form p-l-55 p-r-55 p-t-178" method="post" action="modifier_profile_pc.php">
					<span class="login100-form-title">
					<img src="profil_pc.png" alt="" class="avatar-photo" style='width:150px;padding-bottom:-40px;'>
					<h5 class="text-center"><?php echo( $row['nom_per']);echo( ' '); echo( $row['pre_per']);?></h5>
							<p  id='p2'><b> Personnel du congé<b></p>
					</span>
					<br><br><br><br><br><br>
					CIN:
					<div class="wrap-input100 validate-input m-b-16" data-validate="S'il vous play entrer votre cin">
						<input class="input100" type="text" readonly value="<?php echo( $row['cin_per']);?>">
						<span class="focus-input100"></span>
					</div>
					
					Nom:
					<div class="wrap-input100 validate-input" data-validate = "S'il vous play entrer votre nom"  >
						<input class="input100" type="text" name="nom" placeholder="Nom" value="<?php echo($row['nom_per']);?>">
						<span class="focus-input100"></span>
					</div>
					<br>
					Prénom:
					<div class="wrap-input100 validate-input" data-validate = "S'il vous play entrer votre prénom"  >
						<input class="input100" type="text" name="pre" placeholder="Prénom" value="<?php echo($row['pre_per']);?>">
						<span class="focus-input100"></span>
					</div>
					<br>
					...
					<div class="wrap-input100 validate-input" data-validate = "S'il vous play entrer votre mot de passe"  >
						<input class="input100" type="text" name="mot_ens" placeholder="Mot de passe" value="<?php echo( $row['mot_per']);?>">
						<span class="focus-input100"></span>
					</div>
                    <br>
                    Email:
					<div class="wrap-input100 validate-input" data-validate = "S'il vous play entrer votre Email"  >
						<input class="input100" type="email" name="Email" placeholder="Email" value="<?php echo( $row['ema_per']);?>">
						<span class="focus-input100"></span>
					</div>
					...
					<div class="wrap-input100 validate-input" data-validate = "S'il vous play entrer votre Numéro de téléphone"  >
						<input class="input100" type="number" name="Telephone" placeholder=" Numéro de téléphone" value="<?php echo( $row['tel_per']);?>">
						<span class="focus-input100"></span>
					</div>
