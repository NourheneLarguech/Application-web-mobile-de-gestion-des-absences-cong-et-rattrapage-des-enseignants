...
if(mysqli_num_rows($res)==0)
{
    ...
    $sqls="insert into personnel values('$nom','$pre','$age','$sec','$mai','$min','$id')";
    mysqli_query($connect,$sqls);
    echo '<div class="alert alert-success" role="alert">Personnel ajouter </div>';

}else { echo"<div class='alert alert-danger' role='alert'>
<a href='#' class='alert-link'>Personnel existe </a>
</div>";}
}
