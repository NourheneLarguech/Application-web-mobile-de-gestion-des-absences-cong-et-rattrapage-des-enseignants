...
echo'<td class="table-plus"><a class="upd" href="update.php?id=' . $row['cin_per'] . '"><i class="icon-copy fi-page-edit"></i>  Mettre A jour</a></td>';
echo'<td class="table-plus"><a class="del" href="delete2.php?id=' . $row['cin_per'] . ' "> <i class="icon-copy fa fa-user-times" aria-hidden="true"></i>  Supprimer    </a></td>';
             }
