...
<html>
<head>
<title>Consulter la liste des demandes des
congés qui nécessite une justification</title>
				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h1><b> Liste des demandes des
congés qui nécessite une justification</b></h1>
							</div>
...
?> 
             ...
             while($row=mysqli_fetch_array($res)){
                if($row['etat']=='Donner une justification'){
